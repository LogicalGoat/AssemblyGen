...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void initialize(URL url, ResourceBundle rb) {
        ...
        try{
            tableAssemblyCode.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
            tableAssemblyData.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
            tableMachineC.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
            tableMachineX.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
            tableDatas.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
            tableInstructions.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
        }catch(Exception e){
            System.err.println("sin editar las columnas");
        }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    @FXML public void saveAsButtonAction(ActionEvent event) {
        ...
        fc.setTitle("Elegir ubicaciÃƒÂ³n para archivo de codigo AGF o archivo de texto TXT");
    ...
    @FXML public void closeItemAction(ActionEvent event) {
        ...
        dialog.setHeaderText("Ã‚Â¿Salir?");
        dialog.initStyle(StageStyle.DECORATED);
        dialog.setContentText("Los cambios no guardados se PERDERÃƒÂ�N");
